  ...
  const matchedPlayer: Player | null = useMemo(() => {
    ...
    if (myLogs.length > 0) {
      ...
      return {
        ...
        nationality: userProfileData?.nationality || rosterMatch?.nationality || "-",
        ...
        passes: totalPasses || rosterMatch?.totalPasses || 0,
        successfulPasses: compPasses || rosterMatch?.successfulPasses || 0,
        successful_passes: compPasses || rosterMatch?.successfulPasses || 0,
        ...
        shots_on_target: totalSot || rosterMatch?.shotsOnTarget || 0,
