...
export const parsePlayerStatsExcel = async (file: File, matchIdOverride?: string): Promise<{ count: number; data: any[] }> => {
  ...
  const sanitizedRows = rawRows.map(row => {
    ...
    const cleanPayload = {
      ...
      successful_passes:   Number(extractInt(row, ['successful_passes', 'Successful Passes', 'completed_passes', 'Completed Passes', 'Pass Suc'])) || 0,
      completed_passes:    Number(extractInt(row, ['completed_passes', 'Completed Passes', 'successful_passes', 'Successful Passes', 'Pass Suc'])) || 0,
      backwards_passes:    Number(extractInt(row, ['backwards_passes', 'backwardsPasses', 'backward_passes', 'Backwards', 'Backwards Passes'])) || 0,
      forwards_passes:     Number(extractInt(row, ['forwards_passes', 'forwardsPasses', 'forward_passes', 'Forwards', 'Forwards Passes'])) || 0,
      long_passes:         Number(extractInt(row, ['long_passes', 'longPasses', 'Long Passes'])) || 0,
      successful_long_passes: Number(extractInt(row, ['successful_long_passes', 'successfulLongPasses', 'Long Pass Suc %', 'Long Pass Suc', 'Long Pass Successful', 'long_passes_successful'])) || 0,
      key_passes:          Number(extractInt(row, ['key_passes', 'keyPasses', 'Key Passes'])) || 0,
      successful_key_passes: Number(extractInt(row, ['successful_key_passes', 'successfulKeyPasses', 'Key Pass Suc %', 'Key Pass Suc', 'Key Pass Successful'])) || 0,
      through_balls:       Number(extractInt(row, ['through_balls', 'throughBalls', 'Through Balls'])) || 0,
      successful_through_balls: Number(extractInt(row, ['successful_through_balls', 'successfulThroughBalls', 'Through Ball Suc %', 'Through Ball Suc', 'Through Ball Successful'])) || 0,
      crosses:             Number(extractInt(row, ['crosses', 'Crosses'])) || 0,
      successful_crosses:  Number(extractInt(row, ['successful_crosses', 'successfulCrosses', 'Cross Suc %', 'Cross Suc', 'Cross Successful'])) || 0,

      // Dribbling & Duels
      dribbles:            Number(extractInt(row, ['dribbles', 'Dribbles'])) || 0,
      successful_dribbles: Number(extractInt(row, ['successful_dribbles', 'successfulDribbles', 'Dribble Suc', 'Dribble Suc %', 'Dribble Successful'])) || 0,
      duels:               Number(extractInt(row, ['duels', 'Duels'])) || 0,
      duels_won:           Number(extractInt(row, ['duels_won', 'duelsWon', 'Duels Won', 'Duel Wons', 'Duel Won'])) || 0,
      aerial_duels:        Number(extractInt(row, ['aerial_duels', 'aerialDuels', 'Aerial Duels'])) || 0,
      aerial_duels_won:    Number(extractInt(row, ['aerial_duels_won', 'aerialDuelsWon', 'Aerial Duels Won', 'Aerial Duel Wons', 'Aerial Duel Won'])) || 0,
      ground_duels:        Number(extractInt(row, ['ground_duels', 'groundDuels', 'Ground Duels'])) || 0,
      ground_duels_won:    Number(extractInt(row, ['ground_duels_won', 'groundDuelsWon', 'Ground Duels Won', 'Ground Duel Wons', 'Ground Duel Won'])) || 0,

      // Defence
      ball_recoveries:     Number(extractInt(row, ['ball_recoveries', 'ballRecoveries', 'Ball Recoveries', 'recoveries', 'Ball Recovery'])) || 0,
      tackles:             Number(extractInt(row, ['tackles', 'Tackles'])) || 0,
      tackles_won:         Number(extractInt(row, ['tackles_won', 'tacklesWon', 'Tackles Won', 'Tackle Wons', 'Tackle Won'])) || 0,
      ...
      own_goals:           Number(extractInt(row, ['own_goals', 'ownGoals', 'Own Goals'])) || 0,
      ...
      unsuccessful_dribbles: Number(extractInt(row, ['unsuccessful_dribbles', 'unsuccessfulDribbles', 'unsuccessful_dribble', 'Uns Dribble', 'Unsuccessful Dribbles'])) || 0,
      ...
      yellow_cards:        Number(extractInt(row, ['yellow_cards', 'yellowCards', 'Yellow Cards', 'Yellow Card'])) || 0,
      red_cards:           Number(extractInt(row, ['red_cards', 'redCards', 'Red Cards', 'Red Card'])) || 0,
